...
namespace UdSDK {
	...
	udInt CHClientUr::GetListModel( ) {
		...
		//////////////////////////////////////////////////////////////////////////////////////////
		title = ( modal ? L"Добавить юр. лицо" : L"Новый клиент" );
		url = "#form";
		lnk = new udWndLink( size );
		lnk->get( "title" )->ini( title );
		lnk->get( "url" )->ini( url );
	...
	udInt CHClientUr::GetFormModel( ) {
		...
		m_wndForm->AddText( ctrlidFax, "lfax", NULL, font );
...
/*
	void CHClientUr::CreateWindowModeForm( udPWndModel wnd ) {
		HWND	hWndMode	= NULL,
				hWndModel	= wnd->GetHWnd( ),
				hWnd		= NULL;
		wstring	title	= L"";
		...
		udInt	x		= 0,
				...
				m		= 8,
				lcol	= 108;
		HFONT	hFont	= g_pApp->GetHFont( wnd->GetHWnd( ) );
		HMENU	id		= ( HMENU ) 1000;
		//////////////////////////////////////////////////////////////////////////////////////////
		m_wndForm = new udWndModeForm;
		wnd->apply( m_wndForm );
		m_wndForm->get( "style" )->ini( style );
		m_wndForm->get( "x" )->ini( x );
		m_wndForm->get( "y" )->ini( y );
		m_wndForm->SetStateHandler( this );
		m_wndForm->SetGetObjectCallback( GetProjectClientUr );
		m_wndForm->Create( wnd->GetHWnd( ) );
		//////////////////////////////////////////////////////////////////////////////////////////
		udPGdi		gdi			= m_wndForm->GetGdi( );
		udPBitmap	imgSprite	= g_pApp->GetBitmap( "sprite.png" );
		udPFont		fntLabel	= g_pApp->GetFont( ),	// шрифт надписи
		...
		box->padL = 3; box->padT = 2; box->padR = 3; box->padB = 2;
		box->border = 1; box->border_color = Color::MakeARGB( 255, 180, 180, 180 );
		m_wndForm->AddInput( ctrlidName, "name", box, g_pApp->GetFont( ), 0 );
		y += h + m;
		//////////////////////////////////////////////////////////////////////////////////////////
		title	= L"Руководитель";
		x		= 32;
		...
		box->padL = 3; box->padT = 2; box->padR = 3; box->padB = 2;
		box->border = 1; box->border_color = Color::MakeARGB( 255, 180, 180, 180 );
		m_wndForm->AddInput( ctrlidDfio, "dfio", box, g_pApp->GetFont( ), 0 );
		y += h + m;
		//////////////////////////////////////////////////////////////////////////////////////////
		title	= L"Контактное лицо";
		x		= 32;
		...
		box->padL = 3; box->padT = 2; box->padR = 3; box->padB = 2;
		box->border = 1; box->border_color = Color::MakeARGB( 255, 180, 180, 180 );
		m_wndForm->AddInput( ctrlidCfio, "cfio", box, g_pApp->GetFont( ), 0 );
		y += h + m;
		//////////////////////////////////////////////////////////////////////////////////////////
		title	= L"E-mail";
		x		= 32;
		...
		box->padL = 3; box->padT = 2; box->padR = 3; box->padB = 2;
		box->border = 1; box->border_color = Color::MakeARGB( 255, 180, 180, 180 );
		m_wndForm->AddText( ctrlidEmail, "lemail", box, g_pApp->GetFont( ) );
		y += h + m;
		//////////////////////////////////////////////////////////////////////////////////////////
		title	= L"Телефон";
		x		= 32;
		...
		box->padL = 3; box->padT = 2; box->padR = 3; box->padB = 2;
		box->border = 1; box->border_color = Color::MakeARGB( 255, 180, 180, 180 );
		m_wndForm->AddText( ctrlidPhone, "lphone", box, g_pApp->GetFont( ) );
		y += h + m;
		//////////////////////////////////////////////////////////////////////////////////////////
		title	= L"Факс";
		x		= 32;
		...
		box->padL = 3; box->padT = 2; box->padR = 3; box->padB = 2;
		box->border = 1; box->border_color = Color::MakeARGB( 255, 180, 180, 180 );
		m_wndForm->AddText( ctrlidFax, "lfax", box, g_pApp->GetFont( ) );
		y += h + m;
		//////////////////////////////////////////////////////////////////////////////////////////
		title	= L"Адрес";
		x		= 32;
		...
		box->padL = 3; box->padT = 2; box->padR = 3; box->padB = 2;
		box->border = 1; box->border_color = Color::MakeARGB( 255, 180, 180, 180 );
		m_wndForm->AddText( ctrlidAddr, "laddr", box, g_pApp->GetFont( ) );
		y += h + m;
		//////////////////////////////////////////////////////////////////////////////////////////
		title	= L"Комментарий";
		x		= 32;
		...
		box->padL = 3; box->padT = 2; box->padR = 3; box->padB = 2;
		box->border = 1; box->border_color = Color::MakeARGB( 255, 180, 180, 180 );
		m_wndForm->AddText( ctrlidComment, "comment", box, g_pApp->GetFont( ) );
		y += h + m;
		//////////////////////////////////////////////////////////////////////////////////////////
		w = 107;
		x = 32 + lcol + m;
		...
		m_wndForm->SetButtonOkPosition( inc( &x, w + m ), y );
		m_wndForm->SetButtonCancelPosition( x, y );
		m_wndForm->ShowChildren( );
	} // void CreateWindowModeForm
*/
	/*void CHClientUr::OnLinkClick( udPWndLink lnk ) {
		if ( m_iState == INTSTATE_LIST ) {
			if ( lnk->get( "url" )->toString( ) == "client" ) {
				if ( m_wndModeList->IsModal( ) ) {
					// необходимо переключать состояние
				} else {
					g_pApp->GetModel( )->SetState( "client" );
				}
			} else {
