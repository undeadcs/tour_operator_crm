...
#ifndef SERVERCOREBASEDATATYPES_H
#define SERVERCOREBASEDATATYPES_H
...
namespace UdSDK {
	...
	typedef class CWndServer		udWndServer, *udPWndServer, **udPPWndServer;
	typedef class CUdServer			udServer, *udPServer, **udPPServer;
	...
	typedef class CHObjectLock		udHObjectLock, *udPHObjectLock, **udPPHObjectLock;
