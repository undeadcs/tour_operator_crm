...
namespace UdSDK {
	...
	udPBase GetProjectSTour( ) {
		return new udProjectSTour;
	} // udPBase GetProjectSTour

	CProjectSTour::CProjectSTour( ) {
	...
	void CProjectSTour::GetConfig( udBaseConfig& objConfig ) {
		udBase::GetConfig( objConfig );
		// общие настройки
		objConfig.SetSQLTable( "ud_stour" );
		objConfig.SetPrefix( "stour_" );
